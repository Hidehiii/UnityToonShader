...
float4 _TanLineTex_ST;
float4 _SubShadowTex_ST;
float4 _BodyColor;
float4 _MulColor_01;
float4 _MulColor_02;
float3 _SubShadowxyzOffset;
float3 _SubShadowxyzScale;
float3 _SubShadowxyzRotate;
float _SubShadowBright;
float4 _SubShadowColor_01;
float4 _SubShadowColor_02;
...
TEXTURE2D(_TanLineTex);
SAMPLER(sampler_TanLineTex);
TEXTURE2D(_SubShadowTex);
SAMPLER(sampler_SubShadowTex);
