...
float4 _HiddenColorTex_ST;
half4 _BaseColor_cus;
float4 _HighLightColor;
float4 _HiddenColor_01;
float4 _HiddenColor_02;
float3 _HighLightxyzOffset;
float3 _HighLightxyzRotate;
float3 _HighLightxyzScale;
float _HighLightColorPower;
float3 _HiddenColorxyzOffset;
float3 _HiddenColorxyzRotate;
float3 _HiddenColorxyzScale;
float _HairAlphaRatio;

float _HardShadowRecive_cus;
float _HardShadowReciveThreshold_cus;

half4 _GlossyColor_cus;
half4 _DarkSideColor_cus;
half4 _MidColor_cus;
half4 _RimColor_cus;
float _RampStart_cus;
float _RampSize_cus;
float _RampStepCount_cus;
float _RimColorPower_cus;
...
float3 _ModelPosition_XYZ_Offset;
float _ModelSmoothNormalThreshold;
////////////////////////////////////
half _Surface;
CBUFFER_END
...
TEXTURE2D(_HiddenColorTex);
SAMPLER(sampler_HiddenColorTex);
